  ...
  <div className="paper-grain min-h-screen text-ink">
      ...
      <div className="mt-16 md:mt-20">
        ...
        <div className="space-y-6">
          {[
            ...
            { n: "03", label: "Cans In Hand", img: sippyCans, ratio: "16 / 10", title: "Only 80 kcal of pure joy.", body: "440ml of sparkling blood orange at just 80 calories a can — light, refreshing, and built to slot into a healthy lifestyle without feeling like a compromise. A treat you can reach for daily, guilt-free, between workouts, work calls, and slow Sunday mornings.", meta: ["80 kcal", "440ml", "Better-for-you"] },
            { n: "04", label: "Retail", img: sippyShelf, ratio: "16 / 10", title: "Standing out in the cooler aisle.", body: "Lined up on the shop shelf, the blush pink cans and juicy orange wordmark cut clean through a sea of beige wellness — instantly recognizable, impossible to scroll past, priced to be picked up.", meta: ["Shelf", "Retail"] },
          ].map((c, i) => (
    ...
    <section className="container py-20 md:py-24 text-center">
      ...
      <div className="flex items-center justify-center gap-3 flex-wrap">
        ...
        <Link to="/#contact" className="font-mono text-[11px] small-caps inline-flex items-center gap-2 border border-ink px-5 py-3 hover:bg-ink hover:text-paper transition-colors">
          Contact <ArrowUpRight className="size-3.5" />
        </Link>
      </div>
    </section>
